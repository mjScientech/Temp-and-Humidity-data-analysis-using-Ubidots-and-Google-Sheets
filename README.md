...
**In this , we will measure  temperature and humidity using NCD  temperature and humidity sensor, Esp32, Ubidots.Also send temp and humidity data to Google Sheets using Ubidots.**
